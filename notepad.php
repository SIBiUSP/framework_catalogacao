...
echo 'db.catalog.createIndex({title:"text",authors:"text",type_of_material:"text",ISBN:"text"},{language_override:"pt",weights:{title: 10,authors: 9},name:"TextIndex"})' | mongo sibiusp
